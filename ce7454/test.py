...
model.load_state_dict(torch.load('/data/Projects/OpenPSG/ce7454/checkpoints/coop_pos_weight_lr1e-2_bs32_epoch15_e15_lr0.01_bs32_m0.9_wd0.0005_final.ckpt'))
